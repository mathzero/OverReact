...
tab=crossTab(dat = df,rowvar = "v",colvar = "w",separator = "-",weights = "x1",percentages_only = T,confint = T,rowwise_precentages = F,simpleround = T)
tab_cont=crossTabContinuous(dat = df,rowvar = "x1",colvar = "w")

tabmulti=crossTabMulti(dat = df,rowvar_list = c("x1", "v"),colvar = "w",cov_names=NULL, confint = T,
                       percentages_only = T,sf = 3,
...
tabmulti_w=crossTabMulti(dat = df,rowvar_list = c("x1", "v"),colvar = "w",cov_names=NULL,weights = "x1",
                         ...
                         percentages_only = T,sf = 3,
                         include_percentages = T,
                         rowwise_precentages = T,simpleround = T)
tabmulti_w
